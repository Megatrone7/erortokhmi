...
<head>
    ...
    <link rel="stylesheet" href="{{asset('styleResponsive.css')}}">
    <!-- Add Msi CSS File -->
    <link rel="stylesheet" href="{{asset('msi2.css')}}">
    <link rel="stylesheet" href="{{asset('msiRespnsive.css')}}">
                ...
                <div class="row portfolio-container position-relative w-80 mx-auto ">
                    ...
                    <div class="col-10 col-md-6 col-lg-4 portfolio-item aos-init aos-animate" data-aos="zoom-in"
                        ...
                        <div class="portfolio-wrap">
                            <img src="{{$customer->url}}" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4 class="fw-600">{{$customer->name}}</h4>
                                <p>{{$customer->descroption}}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
